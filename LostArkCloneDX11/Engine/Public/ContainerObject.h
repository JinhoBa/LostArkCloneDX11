...
protected:
	class CPartObject* Find_PartObject(const _wstring& PartObjectTag);
	HRESULT Add_PartObject(_uint iLevelIndex, const _wstring& strPrototypeTag, const _wstring& PartObjectTag, void* pArg = nullptr);
