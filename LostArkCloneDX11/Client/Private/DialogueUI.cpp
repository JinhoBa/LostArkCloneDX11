...
{
    m_NameFontDesc.vColor = _float4(0.66f, 1.f, 0.45f, 1.f);
    m_NameFontDesc.strWord = L"베아트리스";
    m_NameFontDesc.vPositon = _float2(563.f, 555.f);
    m_NameFontDesc.fScale = 0.55f;

    m_ScriptFontDesc.vColor = _float4(1.f, 1.f, 1.f, 1.f);
    m_ScriptFontDesc.strWord = L"빛의 길을 따라 저에게로 오세요";
    m_ScriptFontDesc.vPositon = _float2(518.f, 627.f);
    m_ScriptFontDesc.fScale = 0.35f;
